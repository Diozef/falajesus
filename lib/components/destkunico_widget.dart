...
import 'destkunico_model.dart';
export 'destkunico_model.dart';

class DestkunicoWidget extends StatefulWidget {
  const DestkunicoWidget({super.key});

  @override
  State<DestkunicoWidget> createState() => _DestkunicoWidgetState();
}

class _DestkunicoWidgetState extends State<DestkunicoWidget> {
  late DestkunicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DestkunicoModel());
