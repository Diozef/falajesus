...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Details15Timerhome2',
          path: '/details15Timerhome2',
          builder: (context, params) => const Details15Timerhome2Widget(),
        ),
        FFRoute(
          name: 'homeCopy',
          path: '/homeCopy',
        ...
        FFRoute(
          name: 'modelo',
          path: '/modelo',
          builder: (context, params) => const ModeloWidget(),
        ),
        FFRoute(
          name: 'vermais',
          path: '/vermais',
          builder: (context, params) => const VermaisWidget(),
        ),
        FFRoute(
          name: 'lista',
          path: '/lista',
          builder: (context, params) => const ListaWidget(),
        )
